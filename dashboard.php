                ...
                <div class="table-responsive">
                    <table class="custom-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="item-name">Blog Post Generator</span>
                                </td>
                                <td>Template</td>
                                <td>Aug 25, 2025</td>
                                <td>
                                    <span class="badge-status badge-under-review">Under Review</span>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="item-link">Acme Vision 1.0</a>
                                </td>
                                <td>Model</td>
                                <td>Aug 22, 2025</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="item-link">Email Assistant</a>
                                </td>
                                <td>Template</td>
                                <td>Aug 20, 2025</td>
                                <td>
                                    <span class="badge-status badge-changes-requested">Changes Requested</span>
                                </td>
                                <td style="text-align: right;">
                                    <button class="btn-actions-menu" type="button" title="More options">
                                        <i class="bi bi-three-dots"></i>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="item-link">Acme LLM 1.2</a>
                                </td>
                                <td>Model</td>
                                <td>Aug 18, 2025</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="item-link">Code Explainer</a>
                                </td>
                                <td>Template</td>
                                <td>Aug 15, 2025</td>
                                <td>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Gradient fill for smooth area effect
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    tension: 0.42, // Smooth bezier curve matching the design
                    pointRadius: 0,
                    pointHoverRadius: 6,
