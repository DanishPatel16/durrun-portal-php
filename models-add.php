  ...
  -H "Authorization: Bearer {{api_key}}"</code></pre>
                ...
                <div class="section-card mb-4">
                    ...
                    <ul class="nav nav-pills gap-2 mb-3 border-bottom pb-2" id="codeLangTabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabNode" type="button">Node.js</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabPython" type="button">Python</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabGo" type="button">Go</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabJava" type="button">Java</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabCsharp" type="button">C#</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link py-1 px-3 small fw-semibold rounded-3 text-muted" data-bs-toggle="pill" data-bs-target="#tabCurl" type="button">cURL</button>
                        </li>
                    </ul>
