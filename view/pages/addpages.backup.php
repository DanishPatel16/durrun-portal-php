<?php
$pageTitle = "Add New Model / Page - Durrun Partner Portal";
$activePage = "addpages";
...
<div class="app-wrapper">
    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            ...
            <!-- Form -->
            <form id="addModelForm" action="pageslisting.php" method="POST">
                <div class="row g-4">
                    <!-- Left Column -->
                    <div class="col-12 col-xl-8">
                        ...
                        <div class="section-card mb-4">
                            ...
                            <div class="d-flex flex-wrap gap-4 pt-1">
                                <div class="form-check"><input class="form-check-input" type="checkbox" checked id="pLangNode"><label class="form-check-label small fw-semibold" for="pLangNode">Node.js</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" checked id="pLangPython"><label class="form-check-label small fw-semibold" for="pLangPython">Python</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" checked id="pLangPhp"><label class="form-check-label small fw-semibold" for="pLangPhp">PHP</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="pLangJava"><label class="form-check-label small fw-semibold" for="pLangJava">Java</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" checked id="pLangCsharp"><label class="form-check-label small fw-semibold" for="pLangCsharp">C#</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="pLangGo"><label class="form-check-label small fw-semibold" for="pLangGo">Go</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" checked id="pLangCurl"><label class="form-check-label small fw-semibold" for="pLangCurl">cURL</label></div>
                            </div>
                        </div>
                        ...
                        <div class="section-card mb-4">
                            ...
                            <ul class="nav nav-pills gap-2 mb-3 border-bottom pb-2" id="pCodeTabs" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active py-1 px-3 small fw-semibold rounded-3 d-flex align-items-center gap-2" data-bs-toggle="pill" data-bs-target="#pNodeCode" type="button">
                                        <span class="badge bg-success" style="font-size: 0.65rem;">JS</span> Node.js
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link py-1 px-3 small fw-semibold rounded-3 d-flex align-items-center gap-2" data-bs-toggle="pill" data-bs-target="#pPythonCode" type="button">
                                        <i class="bi bi-terminal text-warning"></i> Python
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link py-1 px-3 small fw-semibold rounded-3 d-flex align-items-center gap-2" data-bs-toggle="pill" data-bs-target="#pPhpCode" type="button">
                                        <span class="badge bg-primary" style="font-size: 0.65rem;">PHP</span> PHP
                                    </button>
                                </li>
                                <li class="nav-item">
                                    <button class="nav-link py-1 px-3 small fw-semibold rounded-3 d-flex align-items-center gap-2" data-bs-toggle="pill" data-bs-target="#pCurlCode" type="button">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="pNodeCode">
                                    <div class="code-box-container position-relative rounded-3 overflow-hidden" style="background-color: #111827; border: 1px solid #1f2937;">
                                        ...
                                        <pre class="p-3 mb-0 text-light" style="font-family: monospace; font-size: 0.85rem; line-height: 1.6; max-height: 380px; overflow-y: auto;"><code><span class="text-muted me-3">1</span><span style="color: #f472b6;">const</span> axios = <span style="color: #60a5fa;">require</span>(<span style="color: #34d399;">'axios'</span>);
                    ...
                    <div class="col-12 col-xl-4">
                        ...
                        <div class="section-card">
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div class="d-flex gap-3 align-items-start"><div class="mt-1 rounded-circle" style="width: 10px; height: 10px; background-color: #94a3b8; min-width: 10px;"></div><div><div class="fw-bold small text-dark">Draft</div><div class="text-muted" style="font-size: 0.8rem;">You can edit and submit later.</div></div></div>
                                <div class="d-flex gap-3 align-items-start"><div class="mt-1 rounded-circle" style="width: 10px; height: 10px; background-color: #f59e0b; min-width: 10px;"></div><div><div class="fw-bold small text-dark">Under Review</div><div class="text-muted" style="font-size: 0.8rem;">Our team is reviewing your submission.</div></div></div>
                                <div class="d-flex gap-3 align-items-start"><div class="mt-1 rounded-circle" style="width: 10px; height: 10px; background-color: #ef4444; min-width: 10px;"></div><div><div class="fw-bold small text-dark">Changes Requested</div><div class="text-muted" style="font-size: 0.8rem;">We'll let you know what needs to be updated.</div></div></div>
                                <div class="d-flex gap-3 align-items-start"><div class="mt-1 rounded-circle" style="width: 10px; height: 10px; background-color: #10b981; min-width: 10px;"></div><div><div class="fw-bold small text-dark">Approved</div><div class="text-muted" style="font-size: 0.8rem;">Your model is approved and ready to go live.</div></div></div>
                                <div class="d-flex gap-3 align-items-start"><div class="mt-1 rounded-circle" style="width: 10px; height: 10px; background-color: #059669; min-width: 10px;"></div><div><div class="fw-bold small text-dark">Live</div><div class="text-muted" style="font-size: 0.8rem;">Your model is publicly available on Durrun.</div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
