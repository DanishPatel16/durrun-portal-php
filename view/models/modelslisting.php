        ...
        <main class="dashboard-main">
            ...
            <div class="welcome-header align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <?php if ($showEmpty): ?>
                        <a href="modelslisting.php" class="btn btn-outline-secondary btn-sm">Show Populated</a>
                    <?php else: ?>
                        <a href="modelslisting.php?empty=1" class="btn btn-outline-secondary btn-sm">Show Empty</a>
                    <?php endif; ?>
                    <a href="addmodels.php" class="btn btn-primary d-flex align-items-center gap-2 px-3 py-2 fw-semibold" style="background-color: #0066ff; border-radius: 8px; font-size: 0.95rem;">
            ...
            <?php if ($showEmpty): ?>
                ...
                <div class="section-card py-5 text-center my-4">
                    ...
                    <a href="addmodels.php" class="btn btn-primary px-4 py-2 fw-semibold" style="background-color: #0066ff; border-radius: 8px;">
                                            ...
                                            <div class="d-inline-flex align-items-center gap-1.5">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="border-radius: 8px; font-size: 0.85rem; min-width: 150px;">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item py-1.5" href="addmodels.php?model=<?php echo urlencode($m['id']); ?>">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px; overflow: hidden;">
            ...
            <div class="modal-footer px-4 py-3 bg-light border-top justify-content-between">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="addmodels.php" id="modalEditBtn" class="btn btn-primary px-3 py-1.5 fw-semibold small d-inline-flex align-items-center gap-1.5" style="background-color: #0066ff; border-radius: 8px;">
...
<script>
    ...
    function openViewModelModal(model) {
        ...
        if (editBtn) {
            editBtn.href = 'addmodels.php?model=' + encodeURIComponent(model.id || '');
        }
